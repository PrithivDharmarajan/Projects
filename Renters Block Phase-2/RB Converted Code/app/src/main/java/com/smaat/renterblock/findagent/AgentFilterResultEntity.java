...
public class AgentFilterResultEntity implements Serializable {
	...
	private ArrayList<AgentReviewsEntity> reviews;
	...
	public ArrayList<AgentReviewsEntity> getReviews() {
		return reviews;
	}

	public void setReviews(ArrayList<AgentReviewsEntity> reviews) {
