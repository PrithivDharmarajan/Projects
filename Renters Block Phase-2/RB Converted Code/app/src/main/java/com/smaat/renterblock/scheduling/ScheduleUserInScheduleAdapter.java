...
public class ScheduleUserInScheduleAdapter extends BaseAdapter implements
	...
	public ScheduleUserInScheduleAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (mAcceptedFriendsList.size() != 0) {
			...
			holder.mCheckName.setBackgroundResource(R.drawable.tick_on);
					...
					if (tag.isCheck) {
						...
						if (mAcceptedFriendsList.get(pos).getFriends_details()
							...
							for (int i = 0; i < ScheduleMeetingActivity.sch_local_arr
								...
								if (ScheduleMeetingActivity.sch_local_arr
										.get(i)
										.getFriends_details()
										.get(0)
										.getUser_name()
							...
							DialogManager
									.showCustomAlertDialog(mContext,
											ScheduleUserInScheduleAdapter.this,
						...
						ScheduleMeetingActivity.sch_local_arr.get(pos)
								.getFriends_details().get(0).setIsRemove("1");
