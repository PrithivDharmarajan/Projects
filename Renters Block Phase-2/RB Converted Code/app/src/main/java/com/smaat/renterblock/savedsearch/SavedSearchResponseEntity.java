...
public class SavedSearchResponseEntity implements Serializable {
    ...
    public String getSavesearchedit() {
        return savesearchedit;
    }

    public void setSavesearchedit(String savesearchedit) {
        this.savesearchedit = savesearchedit;
    }
