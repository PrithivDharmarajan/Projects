...
public class AgentSavedSearchAdapter extends ArrayAdapter<List<String>> {
	...
	public AgentSavedSearchAdapter(Context context, int layout,
		...
		if (act_ent.size() > 0) {
			...
			holder.location_txt.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					AgentFilterActivity.callPlacesApi(location_text);
				}
			});
			...
			holder.saved_list_lay.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					AgentFilterActivity.callPlacesApi(location_name);
				}
			});
			...
			holder.curr_loc.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					AgentFilterActivity.setCurrentLocationDetails();
				}
			});
		}
		return view;
