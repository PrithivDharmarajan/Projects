...
public class ScheduleSavedSearchAdapter extends ArrayAdapter<List<String>> {
	...
	public ScheduleSavedSearchAdapter(Context context, int layout,
		...
		if (act_ent.size() > 0) {
			...
			holder.location_txt.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					ScheduleMeetingActivity.callPlacesApi(location_text);
				}
			});
			...
			holder.saved_list_lay.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					ScheduleMeetingActivity.callPlacesApi(location_name);
					// ScheduleMeetingActivity.getPropertyDetails(lat, longi,
					// location_name);
				}
			});
			...
			holder.curr_loc.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					ScheduleMeetingActivity.setCurrentLocationDetails();
				}
			});
		}
		return view;
