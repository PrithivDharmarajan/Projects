...
public class ListingProfileImageSelection {
	...
	public static void showOption(final Activity context) {
		...
		mFromCamera.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				mDialog.dismiss();
				openCamera(context, ListingProfileImageSelection.CAMERA);
			}
		});
	...
	public static void showOptionNew(final Activity context, final String option) {
		mDialog = new Dialog(context);
		mDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
		mDialog.setContentView(R.layout.phot_selection);
		mDialog.getWindow().setBackgroundDrawable(
		...
		if (option.equalsIgnoreCase("pic")) {
			mTitile.setText("Choose Picture");
			mFromCamera.setText("Take Photo");
			mFromGallery.setText("Choose Existing Photo");
		} else {
			mTitile.setText("Choose Video");
			mFromCamera.setText("Take Video");
			mFromGallery.setText("Choose Existing Video");
		}
		mCancel = (Button) mDialog.findViewById(R.id.cancel);
		mFromCamera.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				...
				if (option.equalsIgnoreCase("pic")) {
					...
					openCamera(context, ListingProfileImageSelection.CAMERA_VIDEO);
				}
			}
		});
		mFromGallery.setOnClickListener(new OnClickListener() {
