...
import com.smaat.renterblock.ui.PostReviewActivty;
import com.smaat.renterblock.ui.ShareAppActivity;
import com.smaat.renterblock.ui.ShareAppActivity.TwDialogListener;

public class TwitterDialog extends Dialog {

	static float[] DIMENSIONS_LANDSCAPE = { 460, 260 };
	static float[] DIMENSIONS_PORTRAIT = { 320, 480 };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//
		// float[] solution = {(width - 80), (height-80)};
		// DIMENSIONS_PORTRAIT = solution;
	...
	private class TwitterWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			if (url.startsWith(ShareAppActivity.CALLBACK_URL)) {
				mListener.onComplete(url);

				TwitterDialog.this.dismiss();
				ShareAppActivity.callUpdateStatus();
				return true;
