...
public class SellFilterObjectEntity implements Serializable {
	...
	private String MLS;
	private String include_estimate;
	...
	// @"price_range_min",@"price_range_max",@"property_type",@"beds",
	// @"baths",@"no_fee",@"square_footage_min",@"square_footage_max",
	// @"year_build_min",@"year_build_max",@"lot_size",@"days_on_RB",@"resale",
	// @"new_construction",@"fore_closure",@"open_house",@"reduced_prices",
	// @"keywords",@"MLS",@"include_estimate",@"sold_within",
	...
	public String getInclude_estimate() {
		return include_estimate;
	}

	public void setInclude_estimate(String include_estimate) {
