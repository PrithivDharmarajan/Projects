...
public class LocalSellPropertyFilter {
	public static SellFilterObjectEntity sellFilter(Context context) {

		SQLiteDatabase db;
		db = DatabaseManager.getInstance().openDatabase();

		SellFilterObjectEntity category = new SellFilterObjectEntity();
		...
		String query = "SELECT * FROM "
				+ RentersBlockDatabase.sell_property_type + " WHERE user_id="
				+ UserID;
