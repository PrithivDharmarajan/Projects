...
public class PropertLeadsEntity implements Serializable {
	...
	private ArrayList<LeadsListEntity> leadslist;
	...
	public ArrayList<LeadsListEntity> getLeadslist() {
		return leadslist;
	}
	public void setLeadslist(ArrayList<LeadsListEntity> leadslist) {
