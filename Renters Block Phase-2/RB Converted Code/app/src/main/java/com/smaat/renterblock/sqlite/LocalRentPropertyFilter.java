...
public class LocalRentPropertyFilter {
	public static RentFilterObjectEntity rentFilter(Context context) {

		SQLiteDatabase db;
		db = DatabaseManager.getInstance().openDatabase();

		RentFilterObjectEntity category = new RentFilterObjectEntity();
		...
		String query = "SELECT * FROM "
				+ RentersBlockDatabase.rent_property_type + " WHERE user_id="
				+ UserID;
