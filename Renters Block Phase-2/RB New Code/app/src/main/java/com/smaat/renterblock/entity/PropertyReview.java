...
public class PropertyReview implements Serializable {
    ...
    public String getProperty_review_id() {
        return property_review_id == null ? AppConstants.FAILURE_CODE : property_review_id;
    }
    ...
    public String getReview_user_id() {
        return review_user_id == null ? AppConstants.FAILURE_CODE : review_user_id;
    }
    ...
    public ArrayList<PostPropertyUserDetails> getReview_user_details() {
        return review_user_details == null ? new ArrayList<PostPropertyUserDetails>() : review_user_details;
    }
