package com.bridgellc.bridge.stickylistview;
...
import com.bridgellc.bridge.stickylistview.WrapperViewList.LifeCycleListener;
...
public class StickyListHeadersListView extends FrameLayout {
	...
	public interface OnStickyHeaderOffsetChangedListener {
		 ...
		 *            The view parent
		 * @param header
		 *            The currently sticky home_screen_grid_header being offset. This home_screen_grid_header is
		 ...
		 * @param offset
		 *            The amount the sticky home_screen_grid_header is offset by towards to top
		 *            of the screen.
		 */
	...
	/**
	 * Notifies the listener when the sticky home_screen_grid_header has been updated
	 */
	public interface OnStickyHeaderChangedListener {
		 ...
		 *            The view parent
		 * @param header
		 *            The new sticky home_screen_grid_header view.
		 * @param itemPosition
		 *            The position of the item within the adapter's data set of
		 *            the item whose home_screen_grid_header is now sticky.
		 * @param headerId
		 *            The id of the new sticky home_screen_grid_header.
		 */
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		// The home_screen_grid_header should be drawn right after the lists children are drawn.
		// This is done so that the home_screen_grid_header is above the list items
	...
	// Reset values tied the home_screen_grid_header. also remove home_screen_grid_header form layout
	...
	private void updateHeader(int headerPosition) {
		...
		// check if there is a new home_screen_grid_header should be sticky
		if (mHeaderPosition == null || mHeaderPosition != headerPosition) {
			...
			if (mHeaderId == null || mHeaderId != headerId) {
				...
				if (mHeader != header) {
					if (header == null) {
						throw new NullPointerException("home_screen_grid_header may not be null");
					}
					swapHeader(header);
				}
				...
				// that it will be set on the home_screen_grid_header and
		...
		// Calculate new home_screen_grid_header offset
	...
	// hides the headers in the list under the sticky home_screen_grid_header.
	...
	private void updateHeaderVisibilities() {
		...
		for (int i = 0; i < childCount; i++) {
			...
			// ensure wrapper view child has a home_screen_grid_header
			WrapperView wrapperViewChild = (WrapperView) child;
			if (!wrapperViewChild.hasHeader()) {
				continue;
			}

			// update home_screen_grid_header views visibility
	...
	// Wrapper around setting the home_screen_grid_header offset in different ways depending on
	// the API version
	@SuppressLint("NewApi")
	...
	private class WrapperViewListLifeCycleListener implements LifeCycleListener {
		...
		public void onDispatchDrawOccurred(Canvas canvas) {
			...
			// therefor we need to update the home_screen_grid_header here as well.
	 ...
	 *            The offset of the sticky home_screen_grid_header fom the top of the view
	 */
