...
public class StickyGridHeadersBaseAdapterWrapper extends BaseAdapter {
    ...
    public int getCount() {
        ...
        for (int i = 0; i < numHeaders; i++) {
            // Pad count with space for home_screen_grid_header and trailing filler in home_screen_grid_header
            // group.
     ...
     * home_screen_grid_header and also spaces to insert headers into some positions will return
     * null.
     * </p>
     * 
     ...
     * the group of items with the given home_screen_grid_header.
     * 
    ...
    protected Position translatePosition(int position) {
        ...
        for (i = 0; i < numHeaders; i++) {
            ...
            // Skip past fake items making space for home_screen_grid_header in front of
            // sections.
            if (place == 0) {
                // Position is first column where home_screen_grid_header will be.
    ...
    /**
     * A view to hold the section home_screen_grid_header and measure the home_screen_grid_header row height
     * correctly.
     * 
     * @author Tonic Artos
     */
    protected class HeaderFillerView extends FrameLayout {
        ...
        /**
         * Set the adapter id for this home_screen_grid_header so we can easily pull it later.
         */
