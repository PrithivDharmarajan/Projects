...
import com.bridgellc.bridge.stickygridview.StickyGridHeadersBaseAdapterWrapper.HeaderFillerView;
...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener,
    ...
    /**
     * Gets the home_screen_grid_header at an item position. However, the position must be that
     * of a HeaderFiller.
     * 
     * @param position Position of HeaderFiller.
     * @return Header View wrapped in HeaderFiller or null if no home_screen_grid_header was
     *         found.
     */
    ...
    /**
     * Get the currently stickied home_screen_grid_header.
     * 
     * @return Current stickied home_screen_grid_header.
     */
    ...
    private void scrollChanged(int firstVisibleItem) {
        ...
        if (childCount != 0) {
            ...
            // Find the next home_screen_grid_header after the stickied one.
            ...
            // Work out where to draw stickied home_screen_grid_header using synchronised
            // scrolling.
            if (viewToWatch != null) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        // Mask the region where we will draw the home_screen_grid_header later, but only if we
        // will draw a home_screen_grid_header and masking is requested.
        ...
        // Draw stickied home_screen_grid_header.
        int wantedWidth;
        if (mHeadersIgnorePadding) {
