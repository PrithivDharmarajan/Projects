 ...
 * method for generating the home_screen_grid_header data set.
 * 
...
public interface StickyGridHeadersSimpleAdapter extends ListAdapter {
    /**
     * Get the home_screen_grid_header id associated with the specified position in the list.
     * 
     * @param position
     *            The position of the item within the adapter's data set whose
     *            home_screen_grid_header id we want.
     * @return The id of the home_screen_grid_header at the specified position.
     */
