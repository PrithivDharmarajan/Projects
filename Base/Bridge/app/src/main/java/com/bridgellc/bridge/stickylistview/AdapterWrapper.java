...
class AdapterWrapper extends BaseAdapter implements StickyListHeadersAdapter {
	...
	/**
	 * Will recycle home_screen_grid_header from {@link WrapperView} if it exists
	 */
	...
	/**
	 * Get a home_screen_grid_header view. This optionally pulls a home_screen_grid_header from the supplied
	...
	private View configureHeader(WrapperView wv, final int position) {
		...
		//if the home_screen_grid_header isn't clickable, the listselector will be drawn on top of the home_screen_grid_header
	...
	/** Returns {@code true} if the previous position has the same home_screen_grid_header ID. */
