...
public class ChatAdapter extends BaseAdapter  implements
    ...
    public static ArrayList<ChatResponseEntity> chatStrings = new ArrayList<ChatResponseEntity>();


    public ChatAdapter(Context context, ArrayList<ChatResponseEntity> chat) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!(chatStrings.get(position).getSender_id().equalsIgnoreCase(GlobalMethods.getUserID(context)))) {
            left_layout.setVisibility(View.VISIBLE);
            left_message.setText(GlobalMethods.getDecodedmessage(chatStrings.get(position).getChat_message()));
            leftProfile.setText(chatStrings.get(position).getSender_first_name());
            leftDate.setText(GlobalMethods.getCustomDateFormate(chatStrings.get(position).getChat_date_time(),mTargetDateTime));
            right_layout.setVisibility(View.GONE);
        } else {
            left_layout.setVisibility(View.GONE);
            right_layout.setVisibility(View.VISIBLE);
            rightDate.setText(GlobalMethods.getCustomDateFormate(chatStrings.get(position).getChat_date_time(),mTargetDateTime));
            rightProfile.setText(chatStrings.get(position).getSender_first_name());
            right_message.setText(GlobalMethods.getDecodedmessage(chatStrings.get(position).getChat_message()));
        }

        if(chatStrings.get(position).getChat_message().equalsIgnoreCase("")) {
