...
/**
 * 
 * the view that wrapps a divider home_screen_grid_header and a normal list item. The listview sees this as 1 item
 * 
...
public class WrapperView extends ViewGroup {
	...
	void update(View item, View header, Drawable divider, int dividerHeight) {
		...
		//same logik as above but for the home_screen_grid_header
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		//measure home_screen_grid_header or divider. when there is a home_screen_grid_header visible it acts as the divider
		if (mHeader != null) {
