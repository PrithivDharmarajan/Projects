    ...
    public void onBindViewHolder(final Holder holder, int position) {
        ...
        if (chatReceiveRes.getMsg_sent_user().equalsIgnoreCase(GlobalMethods.getUserID(mContext))) {
            ...
            if (!chatReceiveRes.getIs_attachement().equalsIgnoreCase(AppConstants.FAILURE_CODE)) {
                ...
                holder.mRightNormalVideoImgLay.setVisibility(View.VISIBLE);
...
//                holder.mRightNormalVideoTxt.setText(GlobalMethods.getMsgDecoder(chatReceiveRes.getAttachement_title()));
                ...
                holder.mRightNormalTopVideoImg.setVisibility(holder.mLeftNormalVideoTxt.getVisibility() == View.VISIBLE ? View.VISIBLE : View.GONE);
                holder.mRightNormalFullVideoImg.setVisibility(holder.mLeftNormalVideoTxt.getVisibility() == View.GONE ? View.VISIBLE : View.GONE);
                if (chatReceiveRes.getIs_attachement().isEmpty() || chatReceiveRes.getIs_attachement().equals(AppConstants.FAILURE_CODE)) {
                    (holder.mRightNormalVideoTxt.getVisibility() == View.GONE ? holder.mRightNormalFullVideoImg : holder.mRightNormalTopVideoImg).setImageResource(R.drawable.default_user_img);
                } else {
                    try {
...
//                        } else {
                        Glide.with(mContext)
                                .load(chatReceiveRes.getAttachement_url()).into(holder.mRightNormalVideoTxt.getVisibility() == View.GONE ? holder.mRightNormalFullVideoImg : holder.mRightNormalTopVideoImg);
//                        Glide.with(mContext)
...
//                        }
                ...
                holder.mRightNormalVideoImgLay.setVisibility(View.GONE);
            ...
            if (!chatReceiveRes.getIs_attachement().equalsIgnoreCase(AppConstants.FAILURE_CODE)) {
                ...
                holder.mLeftNormalVideoImgLay.setVisibility(View.VISIBLE);
                ...
                holder.mLeftNormalTopVideoImg.setVisibility(holder.mLeftNormalVideoTxt.getVisibility() == View.VISIBLE ? View.VISIBLE : View.GONE);
                holder.mLeftNormalFullVideoImg.setVisibility(holder.mLeftNormalVideoTxt.getVisibility() == View.GONE ? View.VISIBLE : View.GONE);

                if (chatReceiveRes.getIs_attachement().isEmpty() || chatReceiveRes.getIs_attachement().equals(AppConstants.FAILURE_CODE)) {
                    (holder.mLeftNormalVideoTxt.getVisibility() == View.GONE ? holder.mLeftNormalFullVideoImg : holder.mLeftNormalTopVideoImg).setImageResource(R.drawable.default_user_img);
                    ...
                    try {
                        ...
                        Glide.with(mContext)
                                .load(chatReceiveRes.getAttachement_url()).into(holder.mLeftNormalVideoTxt.getVisibility() == View.GONE ? holder.mLeftNormalFullVideoImg : holder.mLeftNormalTopVideoImg);
                ...
                holder.mLeftNormalVideoImgLay.setVisibility(View.GONE);
...
//        }
        ...
        holder.mLeftNormalVideoImgLay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent;
                if (mChatListRes.get(holder.getAdapterPosition()).getIs_attachement().equalsIgnoreCase(mContext.getString(R.string.three))) {
                    ...
                    DialogManager.getInstance().showOriginalImgPopup(mContext, GlobalMethods.getMsgDecoder(mChatListRes.get(holder.getAdapterPosition()).getAttachement_url()));
                }

            }
        });
        holder.mRightNormalVideoImgLay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent;
                if (mChatListRes.get(holder.getAdapterPosition()).getIs_attachement().equalsIgnoreCase(mContext.getString(R.string.three))) {
...
//        }
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.left_normal_top_video_img)
        ImageView mLeftNormalTopVideoImg;

        @BindView(R.id.left_normal_full_video_img)
        ImageView mLeftNormalFullVideoImg;

        @BindView(R.id.left_normal_video_txt)
        TextView mLeftNormalVideoTxt;

        @BindView(R.id.right_normal_top_video_img)
        ImageView mRightNormalTopVideoImg;

        @BindView(R.id.right_normal_full_video_img)
        ImageView mRightNormalFullVideoImg;

        @BindView(R.id.right_normal_video_txt)
        TextView mRightNormalVideoTxt;

        @BindView(R.id.left_normal_video_img_lay)
        RelativeLayout mLeftNormalVideoImgLay;

        @BindView(R.id.right_normal_video_img_lay)
        RelativeLayout mRightNormalVideoImgLay;
