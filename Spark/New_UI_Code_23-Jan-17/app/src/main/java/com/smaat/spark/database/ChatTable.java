...
public class ChatTable {
    ...
    private static final String KeyIsAttachment = "IsAttachment";
    private static final String KeyAttachmentURL = "AttachmentURL";
    private static final String KeyAttachmentTitle = "AttachmentTitle";
    private static final String KeyAttachmentVideoID = "AttachmentVideoID";
    private static final String KeyHeaderDate = "HeaderDate";
    ...
    private static final String CREATE_ACTIVITY_TABLE = "CREATE TABLE IF NOT EXISTS " + TableChat + "" +
            ...
            KeyFriendImg + " TEXT," + KeySentMsgUser + " TEXT," + KeyDate + " TEXT," + KeyIsAttachment + " TEXT," + KeyAttachmentURL + " TEXT," + KeyAttachmentTitle + " TEXT," +KeyAttachmentVideoID + " TEXT," + KeyHeaderDate + " TEXT "+
            ")";
    ...
    public static void updateChatTable(ChatReceiveEntity chatModel) {
        ...
        contentValues.put(KeyIsAttachment, chatModel.getIs_attachement());
        contentValues.put(KeyAttachmentURL, chatModel.getAttachement_url());
        contentValues.put(KeyAttachmentTitle, chatModel.getAttachement_title());
        contentValues.put(KeyAttachmentVideoID, chatModel.getVideo_id());
        contentValues.put(KeyHeaderDate, chatModel.getHeader_datetime());
    ...
    public static ArrayList<ChatReceiveEntity> getChatMessageList(ChatReceiveEntity model) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                msgList.setIs_attachement(cursor.getString(cursor.getColumnIndex(KeyIsAttachment)));
                msgList.setAttachement_url(cursor.getString(cursor.getColumnIndex(KeyAttachmentURL)));
                msgList.setAttachement_title(cursor.getString(cursor.getColumnIndex(KeyAttachmentTitle)));
                msgList.setVideo_id(cursor.getString(cursor.getColumnIndex(KeyAttachmentVideoID)));
                msgList.setHeader_datetime(cursor.getString(cursor.getColumnIndex(KeyHeaderDate)));
