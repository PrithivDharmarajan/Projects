...
public class APIRequestHandler {
    ...
    public void callProfileImageUploadAPI(String imagePath, final BaseFragment baseFragment) {
        ...
        RequestBody imageBody = RequestBody.create(MediaType.parse("image/jpeg/jpg/png"), file);
...
//                DialogManager.hideProgress();
    ...
    public void callIgnoreUserAPI(ChatSendReceiveInputEntity fiendsInputEntityRes, final BaseFragment baseFragment) {
        DialogManager.showProgress(baseFragment.getActivity());
        mServiceInterface.ignoreAPICall(fiendsInputEntityRes).enqueue(new Callback<CommonModel>() {
            @Override
...
//                DialogManager.hideProgress();
    ...
    public void callAnonymousAPI(AnonymousInputEntity anonymousInput, final BaseFragment baseFragment) {
        DialogManager.showProgress(baseFragment.getActivity());
        mServiceInterface.anonymousAPICall(anonymousInput).enqueue(new Callback<AnonymousResponse>() {
            @Override
            public void onResponse(Call<AnonymousResponse> call, Response<AnonymousResponse> response) {
                DialogManager.hideProgress();
                if (response.isSuccessful() && response.body() != null) {
                    baseFragment.onRequestSuccess(response.body());
                } else {
            ...
            @Override
            public void onFailure(Call<AnonymousResponse> call, Throwable t) {
                DialogManager.hideProgress();
                baseFragment.onRequestFailure(t);
    ...
    public void callUserNameAPI(NotificationInputEntity userNameInput, final BaseActivity baseActivity) {
//        DialogManager.showProgress(baseActivity);
        mServiceInterface.userNameAPICall(userNameInput).enqueue(new Callback<CommonResponse>() {
            @Override
            public void onResponse(Call<CommonResponse> call, Response<CommonResponse> response) {
//                DialogManager.hideProgress();
                if (response.isSuccessful() && response.body() != null) {
...
//                DialogManager.hideProgress();
    ...
    public void callChatImageUploadAPI(String imgPath, String imgNameStr, String friendIDStr, String messageStr, String subStr, String messageFlowStr, final BaseActivity baseActivity) {
        DialogManager.showProgress(baseActivity);
        File file = new File(imgPath);
        RequestBody imageBody = RequestBody.create(MediaType.parse("image/jpeg/jpg/png"), file);
        MultipartBody.Part api_mode = MultipartBody.Part.createFormData("mode", AppConstants.API_IMAGE_UPLOAD_MODE);
        MultipartBody.Part apiName = MultipartBody.Part.createFormData("api_name", AppConstants.API_CHAT_IMAGE_UPLOAD);
        MultipartBody.Part imgFile = MultipartBody.Part.createFormData("picture", file.getName(), imageBody);


        MultipartBody.Part imgNamePart = MultipartBody.Part.createFormData("name", imgNameStr);
        MultipartBody.Part userIDPart = MultipartBody.Part.createFormData("user_id", GlobalMethods.getUserID(baseActivity));
        MultipartBody.Part friendIDPart = MultipartBody.Part.createFormData("friend_id", friendIDStr);
        MultipartBody.Part messagePart = MultipartBody.Part.createFormData("message", messageStr);
        MultipartBody.Part subjectPart = MultipartBody.Part.createFormData("subject", subStr);
        MultipartBody.Part messageFlowPart = MultipartBody.Part.createFormData("message_flow", messageFlowStr);

        mServiceInterface.chatImageUploadAPICall(api_mode, apiName, imgFile, imgNamePart, userIDPart, friendIDPart, messagePart, subjectPart, messageFlowPart).enqueue(new Callback<CommonModel>() {
            @Override
            public void onResponse(Call<CommonModel> call, Response<CommonModel> response) {
                DialogManager.hideProgress();
                if (response.isSuccessful() && response.body() != null) {
            ...
            @Override
            public void onFailure(Call<CommonModel> call, Throwable throwableMsg) {
                DialogManager.hideProgress();
