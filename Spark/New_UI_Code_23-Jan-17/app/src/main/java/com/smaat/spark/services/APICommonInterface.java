...
public interface APICommonInterface {
    ...
    @POST("spark/index.php/api_interface")
    Call<CommonModel> ignoreAPICall(@Body ChatSendReceiveInputEntity chatReceiveInputEntity);
    ...
    Call<ImageResponse> profileImageUploadAPICall(@Part MultipartBody.Part mode, @Part MultipartBody.Part profileImg, @Part MultipartBody.Part filePart);
    ...
    @POST("spark/index.php/api_interface")
    Call<AnonymousResponse> anonymousAPICall(@Body AnonymousInputEntity anonymousInputEntity);


    @POST("spark/index.php/api_interface")
    Call<CommonResponse> userNameAPICall(@Body NotificationInputEntity settingsInputEntity);


    @Multipart
    @POST("spark/index.php/Api_chat_image_upload")
    Call<CommonModel> chatImageUploadAPICall(@Part MultipartBody.Part mode, @Part MultipartBody.Part apiName, @Part MultipartBody.Part imgFile
            , @Part MultipartBody.Part imgNamePart, @Part MultipartBody.Part userIDPart, @Part MultipartBody.Part friendIDPart, @Part MultipartBody.Part messagePart, @Part MultipartBody.Part subjectPart, @Part MultipartBody.Part messageFlowPart);
