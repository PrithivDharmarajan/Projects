...
public class UserDetailsEntity implements Serializable {
    ...
    private String connect_anon_status;
    ...
    public String getConnect_anon_status() {
        if(connect_anon_status==null){
            connect_anon_status="";
        }
        return connect_anon_status;
    }

    public void setConnect_anon_status(String connect_anon_status) {
        this.connect_anon_status = connect_anon_status;
    }
