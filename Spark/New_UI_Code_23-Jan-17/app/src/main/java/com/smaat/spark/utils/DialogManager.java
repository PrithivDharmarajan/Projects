...
public class DialogManager {
    ...
    private Handler mAlertPopupHandler;
    ...
    public Dialog showAlertPopup(Context context, String message) {
        ...
        //Init View
        popUpParentLay = (LinearLayout) mAlertDialog.findViewById(R.id.popup_parent_lay);
        ...
        mAlertPopupHandler = new Handler();
        mAlertPopupHandler.postDelayed(mAlertPopupRunnable, 2500);
        alertShowing(mAlertDialog);

        return mAlertDialog;

    }
    private Runnable mAlertPopupRunnable = new Runnable() {
        @Override
        public void run() {
            alertDismiss(mAlertDialog);
            removeAlertPopupHandler();
    ...
    private void removeAlertPopupHandler() {
        if (mAlertPopupHandler != null) {
            mAlertPopupHandler.removeCallbacks(mAlertPopupRunnable);
        }
    }
    ...
    public Dialog showOptionPopup(Context context, String message, String firstBtnName, String secondBtnName,
        ...
        mOptionDialog = getDialog(context, R.layout.popup_option_alert);
        WindowManager.LayoutParams lp = new WindowManager.LayoutParams();
...
//            layoutParams.height = ViewGroup.LayoutParams.MATCH_PARENT;
            ...
            mAccDeleteDialog.setCancelable(true);
            mAccDeleteDialog.setCanceledOnTouchOutside(true);
        }
