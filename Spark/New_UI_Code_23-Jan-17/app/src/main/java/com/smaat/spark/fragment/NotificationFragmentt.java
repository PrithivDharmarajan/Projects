...
public class NotificationFragmentt extends BaseFragment implements InterfaceBtnCallback {

    @BindView(R.id.notification_list)
    SwipeMenuListView mNotificationList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.frag_notification_screenn, container, false);
...
//            @Override
//            public void run() {
//                NotificationAdapter adapter = new NotificationAdapter(getActivity(), NotificationFragmentt.this, notificationList);
