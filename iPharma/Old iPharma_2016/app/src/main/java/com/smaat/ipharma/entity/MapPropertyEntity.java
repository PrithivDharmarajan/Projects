...
public class MapPropertyEntity implements Serializable {
	...
	private String PharmacyOffers;
	
	
	public String getPharmacyOffers() {
		return PharmacyOffers;
	}
	public void setPharmacyOffers(String pharmacyOffers) {
	...
	public String getCapturedDevice() {
		return CapturedDevice;
	}
	public void setCapturedDevice(String capturedDevice) {
