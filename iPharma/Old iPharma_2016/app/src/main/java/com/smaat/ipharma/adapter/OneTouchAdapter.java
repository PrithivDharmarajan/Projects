...
public class OneTouchAdapter extends BaseAdapter {
	private int mLayout;
	private Context mContext;
	private ArrayList<MapPropertyEntity> orderList;
	OneTouchFragment myOrderFragemnt;

	public OneTouchAdapter(OneTouchFragment context, int layout,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.mOffersListItemView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				HomeScreen.mFragment = myOrderFragemnt;
				myOrderFragemnt.selectPrescription((MapPropertyEntity)view.getTag());
			}
		});
