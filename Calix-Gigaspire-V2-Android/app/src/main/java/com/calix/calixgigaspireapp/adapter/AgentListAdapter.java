...
public class AgentListAdapter extends RecyclerView.Adapter<AgentListAdapter.Holder> {
    ...
    @NonNull
    @Override
    public AgentListAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.adap_spinner_equ_list, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final AgentListAdapter.Holder holder, int position) {
