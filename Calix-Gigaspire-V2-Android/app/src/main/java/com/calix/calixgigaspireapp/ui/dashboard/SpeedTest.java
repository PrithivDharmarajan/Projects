...
import com.calix.calixgigaspireapp.adapter.dashboard.SpeedTestAdapter;
...
public class SpeedTest extends BaseActivity {
    ...
    /*View onClick*/
    @OnClick({R.id.header_left_img_lay, R.id.begin_speed_test_btn})
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.header_left_img_lay:
                onBackPressed();
                break;
            case R.id.begin_speed_test_btn:
