...
import com.calix.calixgigaspireapp.ui.settings.PinCodeFingerPrintLoginBelow5;
...
public class CalixGigaspireApplication extends android.app.Application {
    ...
    public void pushMsg() {
        ...
        try {
            System.out.print("User Id---" + PreferenceUtil.getUserId(this));
