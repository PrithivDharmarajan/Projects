...
public class DownloadFragment extends BaseFragment {
    ...
    private void setUploadListAdapter(ArrayList<DeviceListResponse> deviceListRes) {
        if (getActivity() != null) {
            ...
            mDownloadRecyclerView.setAdapter(new NetworkUsageAdapter(deviceListRes, true, getContext()));
        }
    }
    ...
    public void onRequestFailure(Object resObj, Throwable t) {
        ...
        if (t instanceof IOException) {
            DialogManager.getInstance().showNetworkErrorPopup(getActivity(),
                    (t instanceof java.net.ConnectException ? getString(R.string.no_internet) : getString(R.string.connect_time_out)), new InterfaceBtnCallback() {
                        @Override
