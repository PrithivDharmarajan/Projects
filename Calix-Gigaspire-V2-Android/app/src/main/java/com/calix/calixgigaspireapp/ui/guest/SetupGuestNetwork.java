...
public class SetupGuestNetwork extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    SwitchButton mIndefiniteSwitchCompat;
    ...
    private void initView() {
        ...
        mIndefiniteSwitchCompat.setOnCheckedChangeListener(this);
...
//                }
    ...
    /*View onClick*/
    @OnClick({R.id.header_left_img_lay, R.id.pwd_in_visible_img, R.id.confirm_pwd_in_visible_img, R.id.start_date_lay, R.id.end_date_lay, R.id.start_time_lay, R.id.end_time_lay, R.id.spinner_drop_down_img, R.id.cont_btn, R.id.delete_btn})
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.pwd_in_visible_img:
                int pwdSelectedInt = mGuestNetworkPwdEdt.getText().toString().length();
                mGuestNetworkPwdEdt.setTransformationMethod(mPwdInVisibleImg.getTag().equals(1) ? null : new PasswordTransformationMethod());
                mGuestNetworkPwdEdt.setSelection(pwdSelectedInt);
            ...
            case R.id.confirm_pwd_in_visible_img:
                int confirmPwdSelectedInt = mGuestNetworkConfirmPwdEdt.getText().toString().length();
                mGuestNetworkConfirmPwdEdt.setTransformationMethod(mConfirmPwdInVisibleImg.getTag().equals(1) ? null : new PasswordTransformationMethod());
                mGuestNetworkConfirmPwdEdt.setSelection(confirmPwdSelectedInt);
            ...
            case R.id.delete_btn:
                DialogManager.getInstance().showOptionPopup(this, getString(R.string.delete_msg), getString(R.string.yes), getString(R.string.no), new InterfaceTwoBtnCallback() {
                    @Override
                    public void onPositiveClick() {
                        ...
                        APIRequestHandler.getInstance().deleteGuestNetworkAPICall(AppConstants.GUEST_WIFI_DETAILS.getEventId(), SetupGuestNetwork.this);
                    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            case R.id.indefinite_switch_compat:
                mIndefiniteSwitchCompat.setBackColor(ContextCompat.getColorStateList(SetupGuestNetwork.this, isChecked ? R.color.blue : R.color.deep_gray));
    ...
    private void validateFields() {
        ...
        } else if (!mIndefiniteSwitchCompat.isChecked() && AppConstants.GUEST_WIFI_DETAILS.getEventId().isEmpty() && DateUtil.getMileSecFromDate(mStartDateTxt.getText().toString().trim(), AppConstants.CUSTOM_DATE_FORMAT) < DateUtil.getMileSecFromDate(AppConstants.CUSTOM_DATE_FORMAT.format(new Date(System.currentTimeMillis())), AppConstants.CUSTOM_DATE_FORMAT)) {
    ...
    public void onRequestSuccess(Object resObj) {
        ...
        if (resObj instanceof GuestWifiEntity) {
            ...
            DialogManager.getInstance().showToast(getApplicationContext(), getString(AppConstants.GUEST_WIFI_DETAILS.getEventId().isEmpty() ? R.string.guest_network_created : R.string.guest_network_updated));
