...
public class RouterMap extends BaseActivity {
    ...
    private void setHeaderView() {
        ...
        mHeaderTxt.setText(getString(R.string.footer_router_map));
    ...
    /*Router Map API calls*/
    private void routerMapAPICall() {
        APIRequestHandler.getInstance().routerMapAPICall(this);
    }

    /*Router Name Update API calls*/
    private void routerNameUpdateAPICall() {
        APIRequestHandler.getInstance().routerNameUpdateAPICall(AppConstants.ROUTER_DETAILS_ENTITY.getRouterId(), AppConstants.ROUTER_DETAILS_ENTITY.getName(), this);
    }
