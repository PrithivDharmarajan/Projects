...
public class ScannedQRBarcode extends BaseActivity {
    ...
    private void initialiseDetectorsAndSources() {
        ...
        mSurfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                try {
                    if (askPermissions() && ActivityCompat.checkSelfPermission(ScannedQRBarcode.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
...
//                Toast.makeText(getApplicationContext(), "To prevent memory leaks barcode scanner has been stopped", Toast.LENGTH_SHORT).show();
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                ...
                if (barcodes.size() != 0 && !mIsScannedBool) {
                    mIsScannedBool = true;
        ...
        if (!listPermissionsNeeded.isEmpty()) {
            addPermission = askAccessPermission(listPermissionsNeeded, 1, new InterfaceTwoBtnCallback() {
                ...
                public void onPositiveClick() {
                    ...
                    if (ActivityCompat.checkSelfPermission(ScannedQRBarcode.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        try {
                            mCameraSource.start(mSurfaceView.getHolder());
                        } catch (IOException e) {
                            e.printStackTrace();
                        ...
                        ActivityCompat.requestPermissions(ScannedQRBarcode.this, new
