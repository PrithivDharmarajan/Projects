...
public class PreferenceUtil {
    ...
    public static String getAuthorization(Context context) {
      ...
      public static String getBaseURL(Context context) {
        return getStringValue(context, AppConstants.USER_SELECTED_BASE_URL).isEmpty()?AppConstants.PRODUCTION_BASE_URL :getStringValue(context, AppConstants.USER_SELECTED_BASE_URL);
     }
